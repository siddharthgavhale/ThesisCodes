...
%Bonnetier Error table: Convergence table and few figures:
%IC--Wulff shape , %Two phase : Shrinking Wulff shape
tic;
...
for i=1:N
    for j=1:N
    K(i,j)=exp(-4*pi*pi*diff_time*((ax*XF(i,j))^2+(ay*YF(i,j))^2));        
    end
end
K_area=1.0;
